"""
Add accessory_id column to order_items table
"""
...
def run_migration():
    ...
    with engine.connect() as conn:
        ...
        try:
            conn.execute(text('''
            ALTER TABLE order_items 
            ADD CONSTRAINT fk_order_items_accessory_id 
    ...
    print("Added accessory_id column to order_items table successfully!")
